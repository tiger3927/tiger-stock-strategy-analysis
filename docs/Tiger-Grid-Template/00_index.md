...
| 02 | [`02_parameters.md`](02_parameters.md) | 全部 48 个参数定义（47 智能体体系 + 1 人工作业层控制）+ 默认值 + 分类速查 | ~150 | 查参数含义、AI可修改哪些参数 |
| 03 | [`03_variables_and_state.md`](03_variables_and_state.md) | 全部 13 个运行时变量 + `_build_status_dict()` | ~80 | 查变量含义、上报AI的状态内容 |
